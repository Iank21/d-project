...
export default function BurnoutHistoryTable({ initialData }: any) {
            ...
            {sortedData.map((item) => (
              <tr key={item.id} className="bg-white border-b">
                ...
                <td className="px-6 py-4 text-right">
                  <Link href={`/history/mbi/${item.id}`} className="font-medium text-blue-600 hover:underline">Подробнее</Link>
                </td>
              </tr>
            ))}
          </tbody>
